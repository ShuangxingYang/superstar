    ...
    <Card title={title}>
      ...
      <div className="mt-1 flex items-start gap-3">
        <button
          ...
          className="shadow-soft-sm hover:shadow-soft-md inline-flex shrink-0 items-center gap-2 rounded-full bg-card px-4 py-2 text-[13px] font-semibold transition-shadow disabled:opacity-50"
        >
          {test.status === 'testing' ? (
        ...
        {test.status !== 'idle' && (
          <span
            className={cn(
              'min-w-0 break-words pt-2 text-[13px] leading-snug',
